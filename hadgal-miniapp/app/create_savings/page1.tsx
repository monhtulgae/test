...
export default function SavingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-teal-800 to-emerald-800 p-4 pb-24">
      {/* Header */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {SAVING_TYPES.map((t) => (
            <button
              ...
              className="relative rounded-2xl overflow-hidden shadow-lg hover:scale-105 hover:shadow-emerald-300/40 transition transform duration-300 bg-white/10 border border-white/20 backdrop-blur-md"
            >
              <Lottie animationData={t.animation} loop className="w-full h-48" />
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-white font-bold text-xl bg-black/30 backdrop-blur-md px-4 py-2 rounded-xl">
                  {t.label}
                </span>
              </div>
            </button>
        ...
        <>
          ...
          <div className="relative mb-6 rounded-2xl overflow-hidden shadow-xl border border-white/10">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/20 backdrop-blur-sm">
              <span className="text-white font-bold text-2xl bg-black/30 px-4 py-2 rounded-xl">
          ...
          <div className="flex flex-row gap-3 mb-6">
            {SAVING_TYPES.filter((t) => t.id !== selectedType).map((t) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/20 backdrop-blur-sm">
                  <span className="text-white font-semibold text-sm text-center px-2 py-1 bg-black/30 rounded-lg">
                    {t.label}
                  </span>
                </div>
              </button>
